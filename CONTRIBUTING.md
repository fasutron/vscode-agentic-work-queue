...
1. The repo includes an `AGENTS.md` with project context that most agents read automatically.
2. `CLAUDE.md` is gitignored. If your agent uses it, create one locally — `AGENTS.md` already covers project context, so your `CLAUDE.md` only needs agent-specific workflow preferences.
